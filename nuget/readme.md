...
Build packages by running [build_packages.cmd](../build_packages.cmd) from a developer environment command line. For testing pass a version number that is much higher than your currently installed, like:

```
c:\repos\cppwinrt> .\build_packages.cmd Release 5.0.0.0
```
